// ==UserScript==
// @name                Scavenging
// @version     	    1.0.5 edited by CodeBen (with Lkav)
// @description         Scavenge for resources automatically
// @author              joaovperin
// @icon                https://i.imgur.com/7WgHTT8.gif
// @include             https://de188.die-staemme.de/game.php?village=1828&screen=place&mode=scavenge
...
(async (ModuleLoader) => {
    ...
    function selecionarTropas(botoesDisponiveis) {
        ...
        var lkav = document.getElementsByName("light")[0];
        ...
        if (botoesDisponiveis == 4) {
            ...
            lkav.value = parseAsInteger($("a.units-entry-all[data-unit='light']")[0].innerText, divisor);
            lkav.dispatchEvent(new KeyboardEvent('keyup', {
                'key': '0'
            }));
            ...
            var nrLkav = $("a.units-entry-all[data-unit='light']")[0];
            nrLanca.click();
            nrEspada.click();
            nrMachado.click();
            nrLkav.click();
